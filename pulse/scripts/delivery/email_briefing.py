...
"""
    ...
    # Generated by pulse/capture_frontpages.py. Each composite already
    # embeds the paper's name as an ALL-CAPS kicker above the headlines
    # column, so we no longer print a separate label above the image.
    # JPGs are uploaded to Bluehost; cache-buster forces Gmail's image
    # proxy to refetch daily (server sends 1-year cache-control).
    ...
    for slug, label, url in _papers:
        html += f"""<table width="100%" cellpadding="0" cellspacing="0"><tr>
<td style="padding: 0;">
  <a href="{url}" target="_blank"><img src="https://home-economics.us/pulse-screenshots/{slug}.jpg?v={_cb}" alt="{label} front page" width="600" style="width: 100%; max-width: 600px; height: auto; display: block;"/></a>
</td></tr></table>
"""
    html += _spacer(24)
