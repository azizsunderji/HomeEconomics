...
GOOGLE_NEWS_QUERIES = [
    # Publication-specific site searches
    ...
    # Reporter name searches — now working properly with googlenewsdecoder
    # resolving Google News redirect URLs to actual article URLs
    # WSJ
