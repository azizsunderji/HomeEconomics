...
7. SINGLE TWEETS DO NOT MAKE THEMES. A lone tweet asking a question, making an observation, or endorsing someone else's argument is NOT a theme — put it in twitter_roundup instead. For Twitter or Bluesky to anchor a theme, you need at least one of: (a) multiple accounts engaging with the same question, (b) the tweet is responding to or commenting on a concrete news story or data release, or (c) the tweet itself has substantial replies/engagement. "[Person] asks what Silicon Valley's best macro call was" is twitter_roundup material. "Multiple economists debate whether remote work suppresses wages" is a theme.
