...
6. CONVERSATION THEMES: 8-12 themes. Each must have platform evidence. At least 2 themes should involve economist/analyst voices. All source types — tweets, Bluesky posts, newspaper articles, newsletter essays, RSS journalism, institutional research — compete equally on merit. Pick whatever is most substantive regardless of platform. Label platforms accurately: use "rss" or "substack" or the newspaper name when that's the anchor, "twitter" or "bluesky" when those anchor it.
