...
def main():
    ...
    print("Loading Redfin data for mobile version...")
    ...
    for metric_key, metric_info in METRICS.items():
        ...
        print(f"Processing {metric_info['display']} for mobile...")
        ...
        output_file = output_path / f"{metric_info['slug']}_mobile.html"
    ...
    import time
    version = int(time.time())
    with open(output_path / 'index_mobile.html', 'w') as f:
        f.write(f'''<!DOCTYPE html>
<html><head>
<meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate">
<meta http-equiv="Pragma" content="no-cache">
<meta http-equiv="Expires" content="0">
<meta http-equiv="refresh" content="0; url=median_sale_price_mobile.html?v={version}">
</head>
<body>Redirecting...</body></html>''')

    print(f"\nGenerated {len(METRICS)} mobile ranking pages")
