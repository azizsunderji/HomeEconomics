...
var tutorialSteps = [
    ...
    {{
        ...
        getEl: function() {{ return document.querySelector('.draw-icon-btn'); }}
    }},
    {{
        title: "Search Locations",
        text: "Search for any ZIP code or place name to jump directly to that location.",
        getEl: function() {{ return document.querySelector('.search-wrapper'); }},
        action: function() {{
            if (typeof drawnBoundary !== 'undefined' && drawnBoundary) {{ clearDrawnBoundary(); }}
            if (typeof isBoundaryView !== 'undefined' && isBoundaryView) {{ toggleVisualization(); }}
        }}
    }},
    {{
